...
import './_form-alert.scss';

const FormAlert = ({ children }) => (
    <div className="form-alert">
        <svg className="form-alert__icon" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
        ...
        <span className="form-alert__text">{ children }</span>
    </div>
);
