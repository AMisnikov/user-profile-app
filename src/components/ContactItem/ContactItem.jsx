...
import { ContactItemEl, ContactItemType, ContactItemValue, ContactItemBtnEdit, ContactItemBtnDelete } from './ContactItem.styles.jsx'
...
const ContactItem = ({type, value, id, deleteContact, setFilterId}) => {
    ...
    return (
        <ContactItemEl>
            <ContactItemType>{type}:</ContactItemType>
            <ContactItemValue>{value}</ContactItemValue>
            <ContactItemBtnEdit onClick={handleEdit}>
            ...
            <ContactItemBtnDelete onClick={handleRemove} >
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
