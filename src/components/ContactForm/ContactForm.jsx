...
const ContactForm = ({ className, createContact, updateContact, resetFilters, currentContact }) => {
    ...
    return (
        <div className={ className ? `contact-form ${className}` : 'contact-form'}>
            { 
                isFormVisible ? 
                (
                    <form onSubmit={handleSubmit} className="contact-form__form" action="#" method="POST" noValidate> 
                        <div className="contact-form__wrapper">
                            <div className="contact-form__row">
                                ...
                                <Input 
                                    ...
                                    value={value} 
                                    className={fieldErrors.length > 0 ? 'contact-form__value input--invalid' : 'contact-form__value'}
                                    errors={fieldErrors}
                                />
                            </div>
                            <div className="contact-form__row contact-form__actions">
                                <Button 
                                    className="btn--black" 
                                    type="submit"
                 ...
                 (
                    <Button 
                        onClick={toggleForm} 
                        className="contact-form__btn-toggle"
                    >
